package cn.edu.guet.backendmanagement.aop;
...
import cn.edu.guet.backendmanagement.util.StringUtils;
...
public class DaoAspect {
    ...
    @Pointcut("execution(* cn.edu.guet.backendmanagement.mapper.*.update*(..))")
    public void daoUpdate() {
    }

    @Pointcut("execution(* cn.edu.guet.backendmanagement.mapper.*.insert*(..))")
