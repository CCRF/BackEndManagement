...
import cn.edu.guet.backendmanagement.util.HttpUtils;
import cn.edu.guet.backendmanagement.util.IPUtils;
...
public class SysLogAspect {
    ...
    @Pointcut("execution(* cn.edu.guet.backendmanagement.service.*.*(..))")
